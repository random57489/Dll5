...
public:
    ...
    {
        printf("Swapping pointer 0x%X to 0x%X", new_table_pointer[index], reinterpret_cast<uintptr_t>(new_function));
    ...
    void ApplyNewTable()
    {
        printf("Applying new table... (0x%X to 0x%X)", reinterpret_cast<uintptr_t>(*class_pointer), reinterpret_cast<uintptr_t>(new_table_pointer));
    ...
    {
        Utilities::Log("Restoring old table... (0x%X to 0x%X)", reinterpret_cast<uintptr_t>(*class_pointer), reinterpret_cast<uintptr_t>(original_pointer));
        *class_pointer = original_pointer;
        Utilities::Log("Old table restored!");
    }
